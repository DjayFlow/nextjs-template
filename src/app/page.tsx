...
export default function Home() {
  ...
  // De veilige manier om te trillen zonder errors
    ...
    return (
      <Page>
        <div style={{ backgroundColor: '#050505', minHeight: '100vh', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', backgroundColor: '#111', padding: '20px', borderRadius: '20px', border: '3px solid #333', marginTop: '40px' }}>
            {reels.map((s, i) => (
          ...
          <div onClick={() => setShowGame(false)} style={{ marginTop: 'auto', marginBottom: '40px', color: '#444', fontWeight: 'bold', cursor: 'pointer' }}>
            BACK TO MENU
          </div>
        </div>
      </Page>
