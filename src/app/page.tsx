...
const CREDIT_LIMIT = 200; // De regel: tot level 200 met credits
...
export default function Home() {
  ...
  // FIX: Berichten verdwijnen na 3 seconden
  useEffect(() => {
    if (eventMsg !== '') {
  ...
  // UPGRADE FUNCTIE (Credits tot level 200, daarna TON)
  const handleUpgradeClick = async () => {
    if (stage < CREDIT_LIMIT) {
      ...
      const transaction = {
        ...
        messages: [{
          address: "UQCHoXWzQZgYjE_9j_l_7pB08M9Y7M7N7O7P7Q7R7S7T", // VUL JE EIGEN WALLET IN
                 ...
                 view === 'radar' ? (
                    ...
                    <div style={{ width: '100%', padding: '10px' }}>
                        ...
                        <Section header="UPGRADES">
                            <Cell subtitle={stage < CREDIT_LIMIT ? `${(stage * 10000).toLocaleString()} Credits` : "0.5 TON"} after={<Button size="s" onClick={handleUpgradeClick}>{stage < CREDIT_LIMIT ? 'LVL UP' : 'DIVINE'}</Button>}>LEVEL UP</Cell>
